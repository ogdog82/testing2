    ...
    def render(self, screen):
        ...
        for i in range(5):  # Create gradient effect
            ...
            pygame.draw.rect(overlay, (40, 40, 40, alpha),
                (self.panel_x + i, self.panel_y + i, self.panel_width - (i * 2), self.panel_height - (i * 2)))
        ...
        content_width = self.panel_width - 40
        content_height = self.panel_height - 40
        ...
        # Draw controls help
        controls_y = self.panel_y + self.panel_height + 10
        controls = [
            "TAB: Switch Tabs",
        ...
        for i, control in enumerate(controls):
            ...
            overlay.blit(control_text, (self.panel_x + (i * 180), controls_y))
